...
alias gdmaster='git diff $(gmb master) HEAD'
alias gdm='git diff $(gmb main) HEAD'
alias vigdmaster='vi $(git diff --name-only `gmb master` HEAD)'
alias vigdm='vi $(git diff --name-only `gmb main` HEAD)'
